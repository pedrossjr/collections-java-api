package com.github.pedrossjr.map.ordenacao;
...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2025, Month.AUGUST,12), "Evento 5", "Atração 5");
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.OCTOBER,11), "Evento 6", "Atração 6");
